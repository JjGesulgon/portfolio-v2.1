function AboutMe({ aboutMe }) {
  return (
    <div className='grid grid-cols-1 xl:grid-cols-6 overflow-hidden mt-64 md:mb-0 lg:mt-40'>
      <div className='col-span-3 xl:bg-blue-400 xl:text-white xl:rounded-r-full text-blue-600'>
      ...
      <div className="flex flex-wrap row-span-1 col-span-3 justify-center mt-10 xl:mt-0">
       ...
       <img src={`https://admin.jjgesulgon.dev/storage/images/${aboutMe.image}`} className="h-auto w-96 mt-10 px-2 md:px-0 rounded-lg" alt="book lover "/>
      </div>
    </div>
  );
}
